...
<!-- Clickable Wizard Block -->
    <div class="block">
        ...
        <div class="block-title">
            <h2>Agregar nuevos <strong>Viajes</strong></h2>
        </div>
        ...
        <form id="advanced-wizard" action="addVia" method="post" class="form-horizontal form-bordered">
            <!-- First Step -->
            <div id="clickable-first" class="step">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-5">
                        <input type="text" name="destino" class="form-control" placeholder="Nuestro proximo viaje es a..." required>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-5">
                                <div class="input-group input-daterange" data-date-format="mm/dd/yyyy">
                                    <input type="text" id="fechaSalida" name="fechaSalida" class="form-control text-center" placeholder="Salida">
                                    <span class="input-group-addon"><i class="fa fa-angle-right"></i></span>
                                    <input type="text" id="fechaRegreso" name="fechaRegreso" class="form-control text-center" placeholder="Regreso">
                                </div>
                    </div>
                 ...
                 <div class="form-group">
                    ...
                    <div class="col-md-5">
                        <div class="input-group bootstrap-timepicker">
                            <input type="text" name="horaSalida" class="form-control input-timepicker24">
                    ...
                    <div class="col-md-5">
                        <div class="input-group bootstrap-timepicker">
                            <input type="text"  name="horaRegreso" class="form-control input-timepicker24">
                            <span class="input-group-btn">
                                <a href="javascript:void(0)" class="btn btn-primary"><i class="fa fa-clock-o"></i></a>
                            </span>
                        </div>
            ...
            <div id="clickable-second" class="step">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-5">
                        <input min="1" type="number" name="asientosDisponibles" class="form-control" placeholder="" required>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-5">
                        ...
                        <input min="0" type="number" id="precio" class="form-control" placeholder="$500.00">
            ...
            <div class="form-group form-actions">
                ...
                <div class="col-md-8 col-md-offset-4">
                    ...
                    <button type="submit" id="btnir" class="btn btn-sm btn-primary" id="next4">Siguiente</button>
                </div>
            </div>
            <!-- END Form Buttons -->
        </form>
    ...
    <!-- END Clickable Wizard Block -->
                ...
                <script >
                    ...
                    document.getElementById("nuevoViaje").className = "active ";  
                  ...
                  <script>
                    ...
                    function agregar(){
                        ...
                        if(boleto != "" && precio != "")
                        {
                            ...
                            cont++;
                            var fila='<tr class="selected" id="fila'+cont+'" onclick="seleccionar(this.id);"><td>'+cont+'</td><td>'+boleto+'</td><td>$'+precio+'<input type="hidden" class="boleto" name="'+cont+'" value="'+boleto+'@'+precio+'"></td></tr>';
                            $('#tabla').append(fila);
                            reordenar();
